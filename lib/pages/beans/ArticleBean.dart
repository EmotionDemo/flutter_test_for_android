...
//**************************** Mon Jan 02 12:15:39 CST 2023  **********
//******************************************************************

import 'package:json_holder_impl/json_holder_impl.dart';

class ArticleBean with JsonHolderImpl<ArticleBean> {
  /// [key : value] => [data : null]
  ...
  @override
  JsonHolderImpl<ArticleBean> provideCreator(Map<String, dynamic> json) {
    return ArticleBean.fromJson(json);
  }

  @override
  List<ArticleBean> provideListCreator() {
    return <ArticleBean>[];
  }

  @override
  List<List<ArticleBean>> provideListListCreator() {
...
class DatasBean with JsonHolderImpl<DatasBean> {
  ...
  /// [key : value] => [shareDate : 1671715179000]
